...
<!-- Page title -->
@section('pageTitle') Executive Membership / Activity @endsection
<!-- End block -->
...
@section('pageContent')
    ...
    <section class="content-header">
        <h1>
            Executive Membership / Activity
            {{-- <small>@if($regiInfo) Update @else Add New @endif</small> --}}
            <small> Add New </small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{URL::route('user.dashboard')}}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="{{URL::to('faculty-activity/list')}}"><i class="fa icon-student"></i>Executive Membership / Activity</a></li>
                ...
                <div class="box box-info">
                    {{-- <form novalidate id="entryForm" action="@if($regiInfo) {{URL::Route('student.update', $regiInfo->id)}} @else {{URL::Route('student.store')}} @endif" method="post" enctype="multipart/form-data"> --}}
                        ...
                        <div class="box-body">
                            ...
                            <p class="lead section-title">Executive Membership / Activity</p>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        <label for="name">Activity / Role<span class="text-danger">*</span></label>
                                        <select name="psn" id="psn" class="form-control show-tick" onchange="basicd()" required="">
                                            <option selected="selected" value="">-Select-</option>
                                            <option value="AICTE Nominee">AICTE Nominee</option>
                                            <option value="Member, BoS">Member, BoS</option>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="nick_name">
                                            Name of the Industry<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Nature of the Journal"></i></label>
                                        ...
                                        <input type="text" name="indnam" id="indnam" class="form-control" required="">
                                        <span class="fa fa-info form-control-feedback"></span>
                                        <span class="text-danger">{{ $errors->first('indnam') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group has-feedback">
                                        <label for="dob">Name of the Board<span class="text-danger">*</span></label>
                                        <input name="brdnam" type="text" id="brdnam" class="form-control" required="">
                                        <span class="fa fa-info form-control-feedback"></span>
                                        
                                        <span class="text-danger">{{ $errors->first('brdnam') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="gender">Date From<span class="text-danger">*</span>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="religion">Date To<span class="text-danger">*</span>
                                        ...
                                        <input type='text' class="form-control date_picker2"  readonly name="dtto" placeholder="date"  required minlength="10" maxlength="255" />  
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="blood_group">Upload File
                                        ...
                                        <input name="prf" type="file" id="prf" accept="pdf/*" onchange="ValidateSingleInputdoc(this);">
                                        <span class="form-control-feedback"></span>
                                        <span class="text-danger">{{ $errors->first('prf') }}</span>
                                    </div>
                                </div>
                                {{-- <div class="col-md-3">
                                    <div class="form-group has-feedback">
                        ...
                        <div class="box-footer">
                            <a href="{{URL::to('faculty-activity/list')}}" class="btn btn-default">Cancel</a>
