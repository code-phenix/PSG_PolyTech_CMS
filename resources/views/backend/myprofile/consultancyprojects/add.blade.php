...
<!-- Page title -->
@section('pageTitle') Consultancy Projects @endsection
<!-- End block -->
...
@section('pageContent')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{URL::to('consultancy-projects/list')}}"><i class="fa icon-student"></i>Consultancy Projects</a></li>
                ...
                <div class="box box-info">
                    {{-- <form novalidate id="entryForm" action="@if($regiInfo) {{URL::Route('student.update', $regiInfo->id)}} @else {{URL::Route('student.store')}} @endif" method="post" enctype="multipart/form-data"> --}}
                        ...
                        <div class="box-body">
                            ...
                            <p class="lead section-title">Consultancy Projects</p>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        <label for="name">Title of the Project<span class="text-danger">*</span></label>
                                        <textarea rows="2" name="cptit" id="cptit" required="required" class="form-control no-resize" placeholder=""></textarea>
                                        ...
                                        <span class="text-danger">{{ $errors->first('cptit') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="nick_name">
                                            Collaboration with<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Nature of the Journal"></i></label>
                                        ...
                                        <input name="cowit" type="text" id="cowit" class="form-control">
                                        <span class="fa fa-info form-control-feedback"></span>
                                        <span class="text-danger">{{ $errors->first('cowit') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group has-feedback">
                                        <label for="dob">Date<span class="text-danger">*</span></label>
                                        <input type='text' class="form-control date_picker2"  readonly name="dat" placeholder="date"  required minlength="10" maxlength="255" />
                                        <span class="fa fa-calendar form-control-feedback"></span>
                                        <span class="text-danger">{{ $errors->first('dat') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="gender">Outcome<span class="text-danger">*</span>
                                        ...
                                        <select name="outc" id="outc" class="form-control show-tick" required="" onchange="selout()">
                                        ...
                                        <span class="text-danger">{{ $errors->first('outc') }}</span>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="religion">Volume of the Amount<span class="text-danger">*</span>
                                        ...
                                        <select name="amtvol" id="amtvol" class="form-control show-tick">
                                            <option selected="selected">-Select-</option>
                                            <option value="10">Above 1 Lakhs</option>
                                            <option value="5">50000 - 1 Lakhs</option>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="blood_group">Amount(in numbers. for ex.:250000)
                                        ...
                                        <input type="text" name="amt" id="amt" required="required" class="form-control">
                                        <span class="form-control-feedback"></span>
                        ...
                        <div class="box-footer">
                            <a href="{{URL::to('consultancy-projects/list')}}" class="btn btn-default">Cancel</a>
