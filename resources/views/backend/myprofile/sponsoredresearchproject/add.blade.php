...
<!-- Page title -->
@section('pageTitle') Sponsored Research Project @endsection
<!-- End block -->
...
@section('pageContent')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{URL::to('sponsored-research-project/list')}}"><i class="fa icon-student"></i> Sponsored Research Project</a></li>
                ...
                <div class="box box-info">
                    {{-- <form novalidate id="entryForm" action="@if($regiInfo) {{URL::Route('student.update', $regiInfo->id)}} @else {{URL::Route('student.store')}} @endif" method="post" enctype="multipart/form-data"> --}}
                        ...
                        <div class="box-body">
                            ...
                            <p class="lead section-title">Sponsored Research Project</p>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        <select name="lvl" id="lvl" class="form-control show-tick">
                                        ...
                                        <span class="text-danger">{{ $errors->first('lvl') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="nick_name">File Number<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Nature of the Journal"></i></label>
                                        ...
                                        <input name="flno" type="text" id="flno" placeholder="Enter the File No." class="form-control" required="">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group has-feedback">
                                        <label for="dob">Title of the Project<span class="text-danger">*</span></label>
                                        <textarea rows="2" name="titprj" id="titprj" class="form-control no-resize" placeholder="Title of the Project" required=""></textarea>
                                        <span class="form-control-feedback"></span>
                                        <span class="text-danger">{{ $errors->first('titprj') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="gender">Abstract<span class="text-danger">*</span>
                                        ...
                                        <textarea rows="2" name="abst" id="abst" class="form-control no-resize" placeholder="Type Abstract.." required=""></textarea>
                                        <span class="form-control-feedback"></span>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="religion">Sanctioned Date<span class="text-danger">*</span>
                                        ...
                                        <input type='text' class="form-control date_picker2"  readonly name="dtfrnew" placeholder="date"  required minlength="10" maxlength="255" />
                                        <span class="fa fa-calendar form-control-feedback"></span>
                                        <span class="text-danger">{{ $errors->first('dtfrnew') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="blood_group">Completed Date
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="nationality">Duration<span class="text-danger">*</span>
                                        ...
                                        <select class="form-control show-tick" name="yr" id="yr" required="">
                                            <option value="" selected="selected">Year</option>
                                                                    ...
                                                                    <select class="form-control show-tick" name="mn" id="mn">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="nationality">Collaborating Agencies
                                            Name & Address</label>
                                            <textarea name="collag" id="collag" rows="2" type="text" class="form-control no-resize" placeholder="Details of Collaborating Agnecies.." required=""></textarea>
                                        {{-- <span class="fa fa-map-marker form-control-feedback"></span> --}}
                                        <span class="text-danger">{{ $errors->first('collag') }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        <label for="photo">Sanctioning/Sponsorship Organization<span class="text-danger">*</span></label>
                                        {{-- <input  type="file" class="form-control" accept=".jpeg, .jpg, .png" name="photo" placeholder="Photo image"> --}}
                                        <select name="spg" class="form-control show-tick" id="spg" onchange="selnat()" required="">
                                            <option value="" selected="selected">-Select-</option>
                                            <option value="PSG CT">PSG CT</option>
                                            <option value="AICTE">AICTE</option>
                                            <option value="AERB">AERB</option><option value="AR&amp;DB">AR&amp;DB </option>
                                            <option value="BCIL">BCIL</option>
                                            ...
                                            <option value="IGCAR">IGCAR</option><option value="Industry Project">Industry Project</option>
                                            <option value="SERB">SERB</option>
                                            <option value="Student Project L-RAMP">Student Project L-RAMP</option>
                                            <option value="Technovator">Technovator</option>
                                            <option value="UGC">UGC</option>
                                            <option value="Others">Others</option>
                                        </select>
                                        <span class="text-danger">{{ $errors->first('spg') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        <label for="email">Volume of Amount</label>
                                        ...
                                        <select name="amtvol" class="form-control show-tick" id="amtvol">
                                            <option selected="selected" value="">-Select-</option>
                                            <option value="5">&lt; 5 Lakhs</option>
                                            <option value="10">5 Lakhs - 10 Lakhs</option>
                                            <option value="15">10 Lakhs - 20 Lakhs</option>
                                            <option value="20">20 Lakhs - 50 Lakhs</option>
                                            <option value="25">&gt; 50 Lakhs</option>
                                        </select>                        
                                        <span class="text-danger">{{ $errors->first('amtvol') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        <label for="phone_no">Amount in Rs.</label>
                                        ...
                                        <input name="amt" type="number" id="amt" class="form-control" placeholder="Type Value.." required="">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        <label for="extra_activity">Investigators</label>
                                        ...
                                        <select name="picopi" class="form-control show-tick" id="picopi" required="">
                                            <option value="" selected="selected">Select</option>
                                            <option value="PI">PI</option>
                                            <option value="Co-PI">CO-PI</option>
                                        </select>
                                        
                                        <span class="text-danger">{{ $errors->first('picopi') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        <label for="note">Current Status</label>
                                        {{-- <textarea name="note" class="form-control"  maxlength="500">@if($student){{ $student->note }}@else{{ old('note') }} @endif</textarea> --}}
                                        <select name="Cstat" class="form-control show-tick" id="Cstat" required="">
                                            <option value="" selected="selected">Select</option>
                                            <option value="Ongoing">Ongoing</option>
                                            <option value="Completed and Submitted UC">Completed and Submitted UC</option>
                                            <option value="Completed and Not Submitting UC">Completed and Not Submitting UC</option>
                                           </select>
                                       
                                        <span class="text-danger">{{ $errors->first('Cstat') }}</span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        {{-- <input type="text" class="form-control" name="father_name" placeholder="name" value="@if($student){{ $student->father_name }}@else{{old('father_name')}}@endif"  maxlength="255"> --}}
                                           ...
                                           <input name="up" type="file" id="up" required="required" accept="pdf/*" onchange="ValidateSingleInputdoc(this);">
                                        <span class="text-danger">{{ $errors->first('up') }}</span>
                                    </div>
                                </div>
                                
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        <label for="father_phone_no">No. of Invstigators</label>
                                        ...
                                        {{-- <span class="fa fa-phone form-control-feedback"></span> --}}
                                        <input type="text" name="noa" id="noa" class="form-control" placeholder="Mention Investigators Count.." required="">
                        ...
                        <div class="box-footer">
                            <a href="{{URL::to('sponsored-research-project/list')}}" class="btn btn-default">Cancel</a>
