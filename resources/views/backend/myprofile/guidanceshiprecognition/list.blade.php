...
@section('pageContent')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Guidance ship Recognition</li>
        </ol>
    </section>
    <!-- ./Section header -->
    <!-- Main content -->
                ...
                <div class="box box-info">
                    {{-- <div class="box-header"> --}}
                        ...
                        <div class="box-tools pull-right">
                            <a class="btn btn-info btn-sm" href="{{URL::to('guidance-ship-recognition/add')}}"><i class="fa fa-plus-circle"></i> Add New</a>
                        </div>
                    {{-- </div> --}}
                    <!-- /.box-header -->
                    {{-- <div class="box-body">
