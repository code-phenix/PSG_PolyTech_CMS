...
<!-- Page title -->
@section('pageTitle') Books Published @endsection
<!-- End block -->
...
@section('pageContent')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{URL::to('books-published/list')}}"><i class="fa icon-student"></i> Books Published</a></li>
            ...
            <div class="col-md-12">
                <div class="box box-info">
                    {{-- <form novalidate id="entryForm" action="@if($regiInfo) {{URL::Route('student.update', $regiInfo->id)}} @else {{URL::Route('student.store')}} @endif" method="post" enctype="multipart/form-data"> --}}
                        <form novalidate id="entryForm" action= "{{URL::Route('student.store')}} " method="post" enctype="multipart/form-data" name="bookpublish">
                        ...
                        <div class="box-body">
                            ...
                            <p class="lead section-title">Books Published  by faculty</p>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        <label for="name">Type of Contribution<span class="text-danger">*</span></label>
                                        ...
                                        <select class="form-control show-tick"  name="type_of_contribution" id="ddlPassport"  required="">
                                        ...
                                        <span class="text-danger">{{ $errors->first('type_of_contribution') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="nick_name">Category<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Category"></i></label>
                                        ...
                                        <select class="form-control show-tick" name="category" id="cat"  onchange="if (this.options[this.selectedIndex].value =='Others'){document.bookpublish['Others'].style.visibility='visible'}else {document.bookpublish['Others'].style.visibility='hidden'};" required="">
                                            <option selected="selected">-Select-</option>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="gender">ISBN No<span class="text-danger">*</span>
                                            <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="select ISBN No"></i>
                                        </label>
                                        ...
                                        <input name="isbn_no" type="text" class="form-control" placeholder="Ente ISBN No.">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="religion">Price(in Rupees)<span class="text-danger">*</span>
                                            <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="select Price(in Rupees)"></i>
                                        </label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="blood_group">Publisher
                                            <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="select Publisher"></i>
                                        </label>
                                        {{-- {!! Form::select('blood_group', AppHelper::BLOOD_GROUP, $bloodGroup , ['class' => 'form-control select2', 'placeholder' => 'select an option']) !!} --}}
                                        <input name="publisher" type="text" class="form-control" placeholder="Type the Publisher" required="">
                                        <span class="form-control-feedback"></span>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="nationality">Upload Approval Letter copy<span class="text-danger">*</span>
                                        ...
                                        <input class="form-control" required="required" placeholder="" name="upload_letter" type="file" id="prf" accept="pdf/*" ">
                                        <span class="form-control-feedback"></span>
                                        <span class="text-danger">{{ $errors->first('upload_letter') }}</span>
                                    </div>
                                </div>
                                {{-- <div class="col-md-3">
                                    <div class="form-group has-feedback">
