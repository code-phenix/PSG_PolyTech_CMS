...
@section('pageContent')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{URL::to('research-expertise/list')}}"><i class="fa icon-student"></i> Research Expertise</a></li>
                ...
                <div class="box box-info">
                    {{-- <form novalidate id="entryForm" action="@if($regiInfo) {{URL::Route('student.update', $regiInfo->id)}} @else {{URL::Route('student.store')}} @endif" method="post" enctype="multipart/form-data"> --}}
                        ...
                        <div class="box-body">
                            ...
                            <p class="lead section-title">Research Expertise</p>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        <label for="name">Broad Domain<span class="text-danger">*</span></label>
                                        <select name="ba" id="ba" onchange="SelectSubDivRA()" class="form-control show-tick">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="nick_name">Sub Area :<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Nature of the Journal"></i></label>
                                        ...
                                        <select name="sd" id="sd" class="form-control show-tick" onchange="rfetch_select(this.value);" style="display: block;">
              
                                            <option value="">-Select-</option><option value="cm_subs" selected="selected">Commerce</option></select>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group has-feedback">
                                        <label for="dob">Subject<span class="text-danger">*</span></label>
                                        <select name="lstDropDown_A[]" id="lstDropDown_A1" multiple="multiple" size="6" onkeydown="fnKeyDownHandler_A(this, event);" onkeyup="fnKeyUpHandler_A(this, event); return false;" onkeypress="return fnKeyPressHandler_A(this, event);" onchange="fnChangeHandler_A(this);" onfocus="fnFocusHandler_A(this);" class="form-control show-tick">



                                            Untitled Document
                                            
                                            <option value="" style="font-family:Courier,monospace;color:#ff0000;background-color:#ffff00;">-Click and Type over for New Subjects-</option><option value="CM011">Corporate Finance </option><option value="CM005">Corporate Law</option><option value="CM002">Economics</option><option value="CM011">Entrepreneurship</option><option value="CM012">Financial Management</option><option value="CM004">Home Science</option><option value="CM013">Marketing</option><option value="CM008">PF  ESI Formulation</option><option value="CM003">Political Science</option><option value="CM001">Principles of Management</option><option value="CM006">Public Administration</option><option value="CM010">Security Analysis abnd Portfolio Management </option><option value="CM007">Social Welfare</option></select> 
