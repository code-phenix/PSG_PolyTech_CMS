...
<!-- Page title -->
@section('pageTitle') Special Lecture Deliverd @endsection
<!-- End block -->
...
@section('pageContent')
    ...
    <section class="content-header">
        <h1>
            Special Lecture Deliverd
            {{-- <small>@if($regiInfo) Update @else Add New @endif</small> --}}
            <small> Add New </small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{URL::route('user.dashboard')}}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="{{URL::to('special-lecture-deliverd/list')}}"><i class="fa icon-student"></i> Special Lecture Deliverd</a></li>
                ...
                <div class="box box-info">
                    {{-- <form novalidate id="entryForm" action="@if($regiInfo) {{URL::Route('student.update', $regiInfo->id)}} @else {{URL::Route('student.store')}} @endif" method="post" enctype="multipart/form-data"> --}}
                        ...
                        <div class="box-body">
                            ...
                            <p class="lead section-title">Special Lecture Deliverd</p>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        <select class="form-control show-tick" name="lvl" id="lvl" required="">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="gender">
                                            Title of the Programme<span class="text-danger">*</span>
                                        ...
                                        <input type="text" name="tit" id="tit" class="form-control" required="">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="religion">Topic<span class="text-danger">*</span>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="blood_group">Organizer
                                        ...
                                        <input name="org" type="text" id="org" class="form-control" required="">
                                        <span class="form-control-feedback"></span>
                                        <span class="text-danger">{{ $errors->first('isnnew_select') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="nationality">Upload File ( Please upload the pdf or image file of size below 3 MB. )<span class="text-danger">*</span>
                                        ...
                                        <input name="prf" type="file" id="prf" accept="pdf/*" onchange="ValidateSingleInputdoc(this);" class="form-control" required="">
                        ...
                        <div class="box-footer">
                            <a href="{{URL::to('special-lecture-deliverd/list')}}" class="btn btn-default">Cancel</a>
