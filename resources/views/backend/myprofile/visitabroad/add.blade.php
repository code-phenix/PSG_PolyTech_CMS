...
@section('pageContent')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{URL::to('visit-abroad/list')}}"><i class="fa icon-student"></i> Visit Abroad</a></li>
                ...
                <div class="box box-info">
                    {{-- <form novalidate id="entryForm" action="@if($regiInfo) {{URL::Route('student.update', $regiInfo->id)}} @else {{URL::Route('student.store')}} @endif" method="post" enctype="multipart/form-data"> --}}
                        ...
                        <div class="box-body">
                            ...
                            <p class="lead section-title">visit-abroad</p>
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="nick_name">To Date<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Nature of the Journal"></i></label>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group has-feedback">
                                        <label for="dob">Organization<span class="text-danger">*</span></label>
                                        <select name="org" id="org" class="form-control show-tick" required="required">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="gender">Organizer<span class="text-danger">*</span>
                                        ...
                                        <input name="orgr" type="text" id="orgr" class="form-control" required="required">
                                        <span class="form-control-feedback"></span>
                                        <span class="text-danger">{{ $errors->first('orgr') }}</span>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="religion">Country<span class="text-danger">*</span>
                                        ...
                                        <select name="cntry" id="cntry" class="form-control show-tick" required="">
                                            <option value="" selected="selected">Select</option>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input type="text" name="place" id="place" class="form-control" required="required">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="nationality">Purpose<span class="text-danger">*</span>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="nationality">File Upload</label>
                                        <input class="form-control" placeholder="" name="vfle" type="file" id="vfle" accept="doc/*" onchange="ValidateSingleInputdoc(this);" required="">
                                        {{-- <span class="fa fa-map-marker form-control-feedback"></span> --}}
                                        <span class="text-danger">{{ $errors->first('vfle') }}</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="box-footer">
                            <a href="{{URL::to('visit-abroad/list')}}" class="btn btn-default">Cancel</a>
