...
<!-- Page title -->
@section('pageTitle') Subject Expertise @endsection
<!-- End block -->
...
@section('pageContent')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{URL::to('subject-expertise/list')}}"><i class="fa icon-student"></i> Subject Expertise</a></li>
                ...
                <div class="box box-info">
                    {{-- <form novalidate id="entryForm" action="@if($regiInfo) {{URL::Route('student.update', $regiInfo->id)}} @else {{URL::Route('student.store')}} @endif" method="post" enctype="multipart/form-data"> --}}
                        ...
                        <div class="box-body">
                            ...
                            <p class="lead section-title">Subject Expertise</p>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        <select name="ba" id="ba" tabindex="1" class="form-control show-tick" onchange="SelectSubDiv()">
                                        ...
                                        <span class="text-danger">{{ $errors->first('ba') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        ...
                                        <select name="sd" id="sd" tabindex="1" class="form-control show-tick" onchange="fetch_select(this.value);">
                                            <option selected="selected">-Select-</option>
                                        </select>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group has-feedback">
                                        ...
                                        <select name="lstDropDown_A[]" id="lstDropDown_A" multiple="multiple"  onkeydown="fnKeyDownHandler_A(this, event);" onkeyup="fnKeyUpHandler_A(this, event); return false;" onkeypress="return fnKeyPressHandler_A(this, event);" onchange="fnChangeHandler_A(this);" onfocus="fnFocusHandler_A(this);" class="form-control show-tick">
                                            <option value="">-Click and Type over for New Subjects-</option> 
                                                     </select>
                                        <span class="text-danger">{{ $errors->first('lstDropDown_A[]') }}</span>
                                    </div>
                                </div>
                        ...
                        <div class="box-footer">
                            <a href="{{URL::to('subject-expertise/list')}}" class="btn btn-default">Cancel</a>
