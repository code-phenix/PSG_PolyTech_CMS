                ...
                <div class="box box-info">
                    {{-- <form novalidate id="entryForm" action="@if($regiInfo) {{URL::Route('student.update', $regiInfo->id)}} @else {{URL::Route('student.store')}} @endif" method="post" enctype="multipart/form-data"> --}}
                        ...
                        <div class="box-body">
                            ...
                            <p class="lead section-title">Basic Details</p>
                            <div class="row">
                                <div class="col-md-4">
                            ...
                            <div class="row">
                             ...
                             <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                    <input type="checkbox" name="present" onclick="">  
                                    ...
                                    <label>Same as Permanent address</label><br>
                                        ...
                                        <p style="float: right">Locality</p><br>
                                        <input value="" name="carea" type="text" id="carea" class="form-control" placeholder=""> 
                                        {{-- <span class="fa fa-phone form-control-feedback"></span> --}}
                                        <span class="text-danger">{{ $errors->first('carea') }}</span>
                                        <p style="float: right">City</p><br>
                                        <input value="" name="ccity" type="text" id="ccity" class="form-control" placeholder=""><br>
                                        <p style="float: right">Pin Code</p><br>
                                        <input  name="cpin" type="text" id="cpin" class="form-control" placeholder=""><br>
                                        {{-- <span class="fa fa-phone form-control-feedback"></span> --}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        {{-- <textarea name="note" class="form-control"  maxlength="500">@if($student){{ $student->note }}@else{{ old('note') }} @endif</textarea> --}}
                                        <input name="ph2"  type="text" id="php2" class="form-control" placeholder="">
                                        <span class="fa fa-info form-control-feedback"></span>
                                        <span class="text-danger">{{ $errors->first('ph2') }}</span></label>
                                        {{-- <textarea name="note" class="form-control"  maxlength="500">@if($student){{ $student->note }}@else{{ old('note') }} @endif</textarea> --}}


                                        <label for="note"><label for="note">Mobile</label>
                                        <input type="number" name="ph1" class="form-control" placeholder="">
                                        <span class="fa fa-info form-control-feedback"></span>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        <textarea name="abt" cols="48" rows="5" id="abt" class="form-control no-resize" placeholder=" ">
                                        <span class="fa fa-info form-control-feedback"></span>
