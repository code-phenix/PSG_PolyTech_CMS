...
<!-- Page title -->
@section('pageTitle') IV Organized and Accompanied @endsection
<!-- End block -->
...
@section('pageContent')
    ...
    <section class="content-header">
        <h1>
            IV Organized and Accompanied
            {{-- <small>@if($regiInfo) Update @else Add New @endif</small> --}}
            <small> Add New </small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{URL::route('user.dashboard')}}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="{{URL::to('iv-organized/list')}}"><i class="fa icon-student"></i> Paper Published</a></li>
                ...
                <div class="box box-info">
                    {{-- <form novalidate id="entryForm" action="@if($regiInfo) {{URL::Route('student.update', $regiInfo->id)}} @else {{URL::Route('student.store')}} @endif" method="post" enctype="multipart/form-data"> --}}
                        ...
                        <div class="box-body">
                            ...
                            <p class="lead section-title">IV Organized and Accompanied</p>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        <label for="name">Industry Details<span class="text-danger">*</span></label>
                                        <input name="indet" required="required" type="text" id="indet" class="form-control">
                                        ...
                                        <span class="text-danger">{{ $errors->first('indet') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="nick_name">From Date<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Nature of the Journal"></i></label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="gender">Place<span class="text-danger">*</span>
                                        ...
                                        <input type="text" required="required" name="place" id="place" class="form-control">
                                        <span class="form-control-feedback"></span>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="religion">No. of Students<span class="text-danger">*</span>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input class="form-control" required="required" placeholder="" name="upfile" type="file" id="upfile" accept="pdf/*" onchange="ValidateSingleInputdoc(this);">
                                        <span class="form-control-feedback"></span>
                                        <span class="text-danger">{{ $errors->first('upfile') }}</span>
                                    </div>
                                </div>
                                {{-- <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        ...
                                        <select name="othind" id="othind" class="form-control show-tick" onchange="oindex()">
                        ...
                        <div class="box-footer">
                            <a href="{{URL::to('iv-organized/list')}}" class="btn btn-default">Cancel</a>
