...
<!-- Page title -->
@section('pageTitle') Department Introduction @endsection
<!-- End block -->
...
@section('pageContent')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{URL::to('department-introduction/list')}}"><i class="fa icon-student"></i> Department Introduction</a></li>
                ...
                <div class="box box-info">
                    {{-- <form novalidate id="entryForm" action="@if($regiInfo) {{URL::Route('student.update', $regiInfo->id)}} @else {{URL::Route('student.store')}} @endif" method="post" enctype="multipart/form-data"> --}}
                        ...
                        <div class="box-body">
                            ...
                            <p class="lead section-title">Department Introduction</p>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        <label for="name">Title of the Department<span class="text-danger">*</span></label>
                                        ...
                                        <input name="dt" required="required" type="text" id="dt" class="form-control">
                                        <span class="text-danger">{{ $errors->first('dt') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="nick_name">Abbreviated Form<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Nature of the Journal"></i></label>
                                        ...
                                        <input name="dc" required="required" type="text" id="dc" class="form-control">
                                        <span class="text-danger">{{ $errors->first('dc') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group has-feedback">
                                        <label for="dob">Year of Establishment<span class="text-danger">*</span></label>
                                        <select name="yoi" id="yoi" class="form-control show-tick" required="">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="gender">Nature of the Head<span class="text-danger">*</span>
                                       ...
                                       <br> <input name="hn" type="radio" class="with-gap" id="radio_11" required="" value="HoD">
                                        <label for="radio_11">HoD</label>
                                       <br> <input name="hn" type="radio" id="radio_12" class="with-gap" value="HoD In-charge" required="">
                                        <label for="radio_12">HoD In-charge</label>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="religion">Name of Head<span class="text-danger">*</span>
                        ...
                        <div class="box-footer">
                            <a href="{{URL::to('department-introduction/list')}}" class="btn btn-default">Cancel</a>
