...
<!-- Page title -->
@section('pageTitle')Staff - Programme / Designation Updation @endsection
<!-- End block -->
...
@section('pageContent')
    ...
    <section class="content-header">
        <h1>
            Staff - Programme / Designation Updation
            {{-- <small>@if($regiInfo) Update @else Add New @endif</small> --}}
            <small> Add New </small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{URL::route('user.dashboard')}}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="{{URL::to('staff-programme-designation-updation/list')}}"><i class="fa icon-student"></i> Staff - Programme / Designation Updation</a></li>
                ...
                <div class="box box-info">
                    {{-- <form novalidate id="entryForm" action="@if($regiInfo) {{URL::Route('student.update', $regiInfo->id)}} @else {{URL::Route('student.store')}} @endif" method="post" enctype="multipart/form-data"> --}}
                        ...
                        <div class="box-body">
                            ...
                            <p class="lead section-title">Staff - Programme / Designation Updation</p>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        <select name="dc" id="dc" onchange="fetch_select(this.value);pfetch_select(this.value);" required="" class="form-control show-tick">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group has-feedback">
                                        ...
                                        <span class="text-danger">{{ $errors->first('an') }}</span>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="religion">Designation<span class="text-danger">*</span>
                                        ...
                                        <select name="deca" id="deca" class="form-control show-tick" required="" onchange="SelectSubCat()">
                                         ...
                                         <div class="form-group ">
                                          ...
                                          <div class="form-line focused">	
                                                ...
                                                <input type="hidden" name="deco" id="deco">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="blood_group" >Programme
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        <label for="present_address">With Effective From</label>
                                        <input type='text' class="form-control date_picker2"  readonly name="dtefrm" placeholder="date"  required minlength="10" maxlength="255" />
                                        <span class="fa fa-calendar form-control-feedback"></span>
                                        <span class="text-danger">{{ $errors->first('dtefrm') }}</span>
                                    </div>
                                </div>
                            </div>
                               {{-- <div class="col-md-4">
                        ...
                        <div class="box-footer">
                            <a href="{{URL::to('staff-programme-designation-updation/list')}}" class="btn btn-default">Cancel</a>
