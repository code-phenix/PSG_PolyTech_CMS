...
<!-- Page title -->
@section('pageTitle') Announcement @endsection
<!-- End block -->
...
@section('pageContent')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{URL::to('announcement/list')}}"><i class="fa icon-student"></i> Announcement</a></li>
                ...
                <div class="box box-info">
                    {{-- <form novalidate id="entryForm" action="@if($regiInfo) {{URL::Route('student.update', $regiInfo->id)}} @else {{URL::Route('student.store')}} @endif" method="post" enctype="multipart/form-data"> --}}
                        ...
                        <div class="box-body">
                            ...
                            <p class="lead section-title">Announcement</p>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        <label for="name">Announcement should be active<span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="nick_name">To<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Nature of the Journal"></i></label>
                                        ...
                                        <input type='text' class="form-control date_picker2"  readonly name="dto" placeholder="date"  required minlength="10" maxlength="255" />
                                        <span class="fa fa-calendar form-control-feedback"></span>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group has-feedback">
                                        <label for="dob">Date of the Event<span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="gender">Title of the Link (Marqueeing Text)<span class="text-danger">*</span>
                                        ...
                                        <textarea rows="4" name="lnktxt" class="form-control no-resize" placeholder="Please type the text to be displayed" required=""></textarea>
                                        <span class="text-danger">{{ $errors->first('lnktxt') }}</span>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="religion">URL to be linked, if any<span class="text-danger">*</span>
                                        ...
                                        <input name="urltxt" type="text" id="urltxt" size="75" onclick="document.ans.file4.disabled=true" class="form-control no-resize" required="">
                                        <span class="text-danger">{{ $errors->first('urltxt') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="blood_group">File to be linked, if any
                                        ...
                                        <input class="form-control" required="required" placeholder="" name="file4" type="file" id="file4" onchange="ValidateSingleInputdoc(this);" onclick="document.ans.urltxt.disabled=true">
                                        <span class="text-danger">{{ $errors->first('file4') }}</span>
                                    </div>
                                </div>
                        ...
                        <div class="box-footer">
                            <a href="{{URL::to('announcement/list')}}" class="btn btn-default">Cancel</a>
