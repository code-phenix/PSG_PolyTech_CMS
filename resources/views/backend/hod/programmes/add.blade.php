...
<!-- Page title -->
@section('pageTitle') Programmes @endsection
<!-- End block -->
...
@section('pageContent')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{URL::to('programmes/list')}}"><i class="fa icon-student"></i> Paper Published</a></li>
                ...
                <div class="box box-info">
                    {{-- <form novalidate id="entryForm" action="@if($regiInfo) {{URL::Route('student.update', $regiInfo->id)}} @else {{URL::Route('student.store')}} @endif" method="post" enctype="multipart/form-data"> --}}
                        ...
                        <div class="box-body">
                            ...
                            <p class="lead section-title">Programmes</p>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        <label for="name">Programme Title<span class="text-danger">*</span></label>
                                        ...
                                        <input type="text" name="progtit" id="progtit" class="form-control" required="">
                                        <span class="text-danger">{{ $errors->first('progtit') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="nick_name">Level<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Nature of the Journal"></i></label>
                                        ...
                                        <input name="proglvl" type="radio" class="with-gap" id="radio_1" value="UG" checked="checked">
                                        <label for="radio_1">UG</label>
                                        <input name="proglvl" type="radio" id="radio_2" class="with-gap" value="PG">
                                        <label for="radio_2">PG</label>
                                        
                                        <span class="text-danger">{{ $errors->first('proglvl') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group has-feedback">
                                        <label for="dob">Nature of the Programme<span class="text-danger">*</span></label>
                                        <br><input name="prognat" type="radio" class="with-gap" id="radio_11" checked="checked" value="Full Time">
                                        <label for="radio_11">Full Time</label>
                                        <br> <input name="prognat" type="radio" id="radio_12" class="with-gap" value="Part Time">
                                        <label for="radio_12">Part Time</label>
                                        <br> <input name="prognat" type="radio" id="radio_13" class="with-gap" value="Sandwich">
                                        <label for="radio_13">Sandwich</label>
                                        <br><input name="prognat" type="radio" id="radio_14" class="with-gap" value="Integrated">
                                        <label for="radio_14">Integrated</label>
                                        <span class="text-danger">{{ $errors->first('prognat') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="gender">Type<span class="text-danger">*</span>
                                        ...
                                        <br><input name="progtype" type="radio" class="with-gap" id="radio_21" value="Grant-inAid">
                                      <label for="radio_21">Grant-in-Aid</label>
                                        <input name="progtype" type="radio" id="radio_22" class="with-gap" value="SS" checked="checked">
                                         <label for="radio_22">Self Supporting</label>
                                        <span class="text-danger">{{ $errors->first('progtype') }}</span>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="religion">Year of Introduction<span class="text-danger">*</span>
                                        ...
                                        <select name="yoi" id="yoi" class="form-control show-tick">
                                        ...
                                        <span class="text-danger">{{ $errors->first('yoi') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="blood_group">Duration
                                        ...
                                        <select name="progdur" id="progdur" class="form-control show-tick">
                                            <option value="0" selected="selected">-Year-</option>
                                        ...
                                        <span class="text-danger">{{ $errors->first('progdur') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="nationality">Sanctioned Intake<span class="text-danger">*</span>
                                        ...
                                        <input type="text" name="progsanc" id="progsanc" class="form-control" required="">
                                        <span class="text-danger">{{ $errors->first('progsanc') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="nationality">Programme Coordinator Code</label>
                                        
                                        {{-- <span class="fa fa-map-marker form-control-feedback"></span> --}}

                                        <select name="dc" id="dc" onchange="fetch_select(this.value)" class="form-control show-tick">
                                            <option value="" selected="selected">-Department-</option>
                                               ...
                                               <select name="faccode" id="faccode" class="form-control show-tick">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        <label for="photo">Programme Coordinator Code<span class="text-danger">*</span></label>
                                        {{-- <input  type="file" class="form-control" accept=".jpeg, .jpg, .png" name="photo" placeholder="Photo image"> --}}
                                        <select name="dc2" id="dc2" onchange="g2fetch_select(this.value)" class="form-control show-tick">
                                            <option value="" selected="selected">-Department-</option>
                                                          <option value="AFD"> Apparel &amp; Fashion Design </option>
                                                           <option value="AMC"> Applied Mathematics &amp; Computational  Sciences </option>
                                                           <option value="AS"> Applied Science </option>
                                               ...
                                               <select name="faccode2" id="faccode2" class="form-control show-tick">
                                                 <option value="" selected="selected">-Select-</option>
                                                 </select> 
                                        <span class="text-danger">{{ $errors->first('faccode2') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        <label for="email">About the Programme</label>
                                        ...
                                        <textarea rows="4" name="abtpgm" class="form-control no-resize" placeholder="Please type about the programme..."></textarea>
                                        <span class="text-danger">{{ $errors->first('abtpgm') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        <a href="#" class="style45">Click here to upload </a><br>
                                        <a href="#">Click here for Online Course Material </a> 
                        ...
                        <div class="box-footer">
                            <a href="{{URL::to('programmes/list')}}" class="btn btn-default">Cancel</a>
