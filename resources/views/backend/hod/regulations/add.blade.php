...
<!-- Page title -->
@section('pageTitle') Regulations @endsection
<!-- End block -->
...
@section('pageContent')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{URL::to('regulations/list')}}"><i class="fa icon-student"></i> Regulations</a></li>
                ...
                <div class="box box-info">
                    {{-- <form novalidate id="entryForm" action="@if($regiInfo) {{URL::Route('student.update', $regiInfo->id)}} @else {{URL::Route('student.store')}} @endif" method="post" enctype="multipart/form-data"> --}}
                        ...
                        <div class="box-body">
                            ...
                            <p class="lead section-title">Regulations</p>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        <select required="" name="pcode" id="pcode" class="form-control show-tick">
                            <option value="" selected="selected">-Select-</option>
                                                            <!--<option value="nmcc/NMC-UG1"> nmcc </option>-->
                                <option value="NMC-UG1"> nmcc </option>
                                                        </select>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="nick_name">Year<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Nature of the Journal"></i></label>
                                        ...
                                        <select required="" name="yoi" id="yoi" class="form-control show-tick">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group has-feedback">
                                        <label for="dob">Regulation<span class="text-danger">*</span></label>
                                        <input class="form-control" required="required" placeholder="" name="reg" type="file" id="reg" accept="pdf/*" onchange="ValidateSingleInputHL(this);">
                                        <span class="text-danger">{{ $errors->first('reg') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="gender">PO<span class="text-danger">*</span>
                                        ...
                                        <input class="form-control" required="required" placeholder="Outcome" name="po" type="file" id="po" accept="pdf/*" onchange="ValidateSingleInputHL(this);">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="religion">PSO<span class="text-danger">*</span>
                                        ...
                                        <input class="form-control" placeholder="Specific Outcome" name="pso" type="file" id="pso" accept="pdf/*" onchange="ValidateSingleInputHL(this);">
                                        <span class="text-danger">{{ $errors->first('pso') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="blood_group">PEO
                                        ...
                                        <input class="form-control" required="required" placeholder="Expected Outcome" name="peo" type="file" id="peo" accept="pdf/*" onchange="ValidateSingleInputHL(this);">
                                        <span class="text-danger">{{ $errors->first('peo') }}</span>
                                    </div>
                                </div>
                        ...
                        <div class="box-footer">
                            <a href="{{URL::to('regulations/list')}}" class="btn btn-default">Cancel</a>
