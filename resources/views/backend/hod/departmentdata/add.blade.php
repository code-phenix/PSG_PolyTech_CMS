...
<!-- Page title -->
@section('pageTitle') Department Data @endsection
<!-- End block -->
...
@section('pageContent')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{URL::to('department-data/list')}}"><i class="fa icon-student"></i> </a>Department Data</li>
                ...
                <div class="box box-info">
                    {{-- <form novalidate id="entryForm" action="@if($regiInfo) {{URL::Route('student.update', $regiInfo->id)}} @else {{URL::Route('student.store')}} @endif" method="post" enctype="multipart/form-data"> --}}
                        ...
                        <div class="box-body">
                            ...
                            <p class="lead section-title">Department Data</p>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        <label for="name">Year of Establishment<span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="nick_name">About the Department<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Nature of the Journal"></i></label>
                                        ...
                                        <textarea rows="4" name="abt" class="form-control no-resize"></textarea>(Length of 1000 characters.)
                                        <span class="text-danger">{{ $errors->first('abt') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group has-feedback">
                                        <label for="dob">Vision of the Department<span class="text-danger">*</span></label>
                                        <textarea rows="4" name="vsn" class="form-control no-resize"></textarea>(Length of 500 characters.)
                                        <span class="text-danger">{{ $errors->first('vsn') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="gender">Mission of the Department<span class="text-danger">*</span>
                                        ...
                                        <textarea rows="4" name="msn" class="form-control no-resize"></textarea>(Length of 500 characters.)
                                        <span class="form-control-feedback"></span>
                                        <span class="text-danger">{{ $errors->first('msn') }}</span>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="religion">HoD's Image<span class="text-danger">*</span>
                                        ...
                                        <input class="form-control" placeholder="" name="hdimg" type="file" id="hdimg" accept="pdf/*" onchange="ValidateSingleInput(this);">
                                        <span class="text-danger">{{ $errors->first('hdimg') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="blood_group">HoD's Desk
                                        ...
                                        <textarea rows="4" name="hdm" class="form-control no-resize"></textarea>(Length of 1000 characters.)
                                        <span class="text-danger">{{ $errors->first('hdm') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="nationality">Add Images for Flash / Photo Gallery<span class="text-danger">*</span>
                                        ...
                                        <input class="form-control" type="file" id="files[]" name="files[]" multiple="multiple" accept="image/*" onchange="ValidateSingleInput(this);">
                        ...
                        <div class="box-footer">
                            <a href="{{URL::to('department-data/list')}}" class="btn btn-default">Cancel</a>
