...
<!-- Page title -->
@section('pageTitle') Online Course Material @endsection
<!-- End block -->
...
@section('pageContent')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{URL::to('online-course-material/list')}}"><i class="fa icon-student"></i> Online Course Material</a></li>
                ...
                <div class="box box-info">
                    {{-- <form novalidate id="entryForm" action="@if($regiInfo) {{URL::Route('student.update', $regiInfo->id)}} @else {{URL::Route('student.store')}} @endif" method="post" enctype="multipart/form-data"> --}}
                        ...
                        <div class="box-body">
                            ...
                            <p class="lead section-title">Online Course Material</p>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        <label for="name">Title of the course<span class="text-danger">*</span></label>
                                        ...
                                        <input type="text" name="lnktxt" id="lnktxt" class="form-control" required="">
                                        <span class="text-danger">{{ $errors->first('lnktxt') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="nick_name">File to be linked, if any<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Nature of the Journal"></i></label>
                                        ...
                                        <input class="form-control" required="required" placeholder="" name="file4" type="file" id="file4" accept="pdf/*" onchange="ValidateSingleInputHL(this);">
                        ...
                        <div class="box-footer">
                            <a href="{{URL::to('online-course-material/list')}}" class="btn btn-default">Cancel</a>
