...
@section('pageContent')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{URL::to('news/list')}}"><i class="fa icon-student"></i> News</a></li>
                ...
                <div class="box box-info">
                    {{-- <form novalidate id="entryForm" action="@if($regiInfo) {{URL::Route('student.update', $regiInfo->id)}} @else {{URL::Route('student.store')}} @endif" method="post" enctype="multipart/form-data"> --}}
                        ...
                        <div class="box-body">
                            ...
                            <p class="lead section-title">News</p>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        <label for="name">Date of the Event<span class="text-danger">*</span></label>
                                        ...
                                        <input type='text' class="form-control date_picker2"  readonly name="doe" placeholder="date"  required minlength="10" maxlength="255" />
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="nick_name">Title of the Link<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Nature of the Journal"></i></label>
                                        ...
                                        <textarea rows="4" name="lnktxt" class="form-control no-resize" placeholder="Please type the news to be displayed" required=""></textarea>
                                        <span class="text-danger">{{ $errors->first('lnktxt') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group has-feedback">
                                        <label for="dob">URL to be linked, if any<span class="text-danger">*</span></label>
                                        <input name="urltxt" type="text" id="urltxt" size="75" onclick="document.news.newfil.disabled=true" class="form-control no-resize">
                                        <span class="text-danger">{{ $errors->first('urltct') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="gender">File to be linked, if any<span class="text-danger">*</span>
                                        ...
                                        <input class="form-control" placeholder="" name="newfil" type="file" id="newfil" onchange="ValidateSingleInputdoc(this);" onclick="document.news.urltxt.disabled=true">
                        ...
                        <div class="box-footer">
                            <a href="{{URL::to('news/list')}}" class="btn btn-default">Cancel</a>
