...
<!-- Page title -->
@section('pageTitle') Department Profile @endsection
<!-- End block -->
...
@section('pageContent')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{URL::route('class_profile.index')}}"><i class="fa fa-picture-o"></i> Department Profile</a></li>
                ...
                <div class="box box-info">
                    <form novalidate id="classProfileAddForm" action="@if($profile) {{URL::Route('class_profile.update', $profile->id)}} @else {{URL::Route('class_profile.store')}} @endif " method="post" enctype="multipart/form-data">
                        <div class="box-header">
                            <h3 class="box-title">@if($profile) Update @else Add @endif Department Profile<span class="text-danger"> * Marks are required feild</span></h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            @csrf
                            ...
                            <div class="form-group has-feedback">
                                <label for="teacher">Department Teacher<span class="text-danger">*</span></label>
