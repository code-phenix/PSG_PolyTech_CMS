...
<!-- Page title -->
@section('pageTitle') Student Strength @endsection
<!-- End block -->
...
@section('pageContent')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{URL::to('student-strength/list')}}"><i class="fa icon-student"></i> Student Strength</a></li>
                ...
                <div class="box box-info">
                    {{-- <form novalidate id="entryForm" action="@if($regiInfo) {{URL::Route('student.update', $regiInfo->id)}} @else {{URL::Route('student.store')}} @endif" method="post" enctype="multipart/form-data"> --}}
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        <select name="yoi" id="yoi" required="">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="nick_name">Nature of the Programme<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Nature of the Journal"></i></label>
                                        ...
                                        <select name="nat" id="nat" tabindex="1" required="">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group has-feedback">
                                        <label for="dob">Programme<span class="text-danger">*</span></label>
                                        <select name="prg" id="prg" required="">
                                            <option selected="selected" value="">Select</option>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        <label for="gender">Programme Year<span class="text-danger">*</span>
                        ...
                        <div class="box-footer">
                            <a href="{{URL::to('student-strength/list')}}" class="btn btn-default">Cancel</a>
