...
{{-- <a href="{{ URL::route('user.dashboard') }}" class="logo hidden-xs">
      ...
      <img style="max-width: 50px; max-height: 50px;" src="{{ public_path('images/logo-md.png') }}" alt="logo-mini">
      </span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">
        <img style="max-width: 230px; max-height: 50px;" src="{{ public_path('images/logo-md.png') }} " alt="logo-md">
      </span>
    </a> --}}
